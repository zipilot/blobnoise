...
import type { BlobConfig } from "@alejo-valencia/blobnoise";
import type { ExportCapabilities } from "@alejo-valencia/blobnoise/export";
...
export function ExportDialog({ config, time, onClose, notify }: {
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(() => {
      void import("@alejo-valencia/blobnoise/export").then(module => module.getExportCapabilities({
  ...
  const startExport = async () => {
    ...
    try {
      const module = await import("@alejo-valencia/blobnoise/export");
